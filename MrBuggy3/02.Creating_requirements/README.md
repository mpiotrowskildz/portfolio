...
35. Each user of the server app has to have a seperate login which consists of 4-8 characters (at least one lowercase letter, one uppercase letter, one number 0-9 and one special character).
36. The login to the server app cannot include white-space characters and/or Polish diacritics).
36. The password to the server app has to contain at least 4 characters (at least one lowercase letter, one uppercase letter, one number 0-9 and one special character).
37. The password cannot include white-space characters and/or Polish diacritics).
38. Every user of the client app that chooses to create an account has to create a username, provide their e-mail address and set a password.
39. The username in the client app cannot exceed 100 characters (white-space characters, Polish diacritics and special characters in the latin alphabet are allowed).
40. The password in the client app cannot exceed 15 characters.
41. The password to the client app has to contain at least 4 characters (at least one lowercase letter, one uppercase letter, one number 0-9 and one special character).
42. The password cannot include white-space characters and/or Polish diacritics).
